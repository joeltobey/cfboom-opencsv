    ...
    output="false"
{
    ...
    public void function testDBQueryWithHeaders() {
        ...
        queryService.setSql("SELECT * FROM `All_Types`;");
        ...
        var expected = fileRead( expandPath("/tests/resources/all_types.csv") );
    ...
    public void function testDBQueryWithoutHeaders() {
        ...
        var expected = fileRead( expandPath("/tests/resources/all_types_without_headers.csv") );
    ...
    public void function testDBQueryTrim() {
        ...
        var expected = fileRead( expandPath("/tests/resources/all_types_trimmed.csv") );
